...
function ( declare, Query, QueryTask, FeatureLayer, ArcGISDynamicMapServiceLayer, Graphic, GraphicsLayer, SimpleFillSymbol, SimpleLineSymbol, Color, Polygon,) {
	...
	return declare(null, { 
		eventListeners: function(t){
			t.url = 'http://services.coastalresilience.org/arcgis/rest/services/Resilient_Coastal_Cities/Indonesia/MapServer'
		    ...
		    function showEventButtons(val){
		    	...
		    	if (val == 'last30') {
		    		...
		    		currentStartDate = nxew Date(t.obj.getDate(d,180))
		    	}
	    		var counter = 0;
